...
export default function ReceiptNFT({
  ...
  const buyNow = async () => {
    ...
    const transactionParameters = {
      ...
      value: web3.utils.toHex(web3.utils.toWei(currencyAmount, "ether")),
    };
    ...
    try {
      ...
      if (txHash) {
        ...
        var config = {
          method: "post",
          url: "https://receipt-nft.yokupass.com/yokupay/opentheta/buyNFT",
          headers: {
            Authorization: process.env.REACT_APP_BEAR,
            "Content-Type": "application/x-www-form-urlencoded",
          },
          ...
          if (json.status === 200) {
            ...
            axios(config).then((response) => {
              if (response.status === 200) {
                ...
                var config = {
                  method: "post",
                  url: "https://receipt-nft.yokupass.com/database/closed_orders",
                  headers: {
                    Authorization: process.env.REACT_APP_BEAR,
                    "Content-Type": "application/x-www-form-urlencoded",
                  },
